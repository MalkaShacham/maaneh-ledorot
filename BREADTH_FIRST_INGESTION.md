...
## מצב האצה — Verification Surge

החל מ־22.09.2026, כל עוד קיים backlog משמעותי של רשומות promotion-ready, מסלול הקידום והאימות הוא המסלול הדומיננטי.

- יעד מאמץ: **70–80%** לקידום, אימות, dedup, קטלוג סופי ו־Evidence Families; **20–30%** להרחבת breadth.
- batch מועדף: **10–25 פריטים הומוגניים** כאשר קיימים item-level witnesses ישירים/מוסמכים יציבים.
- כאשר רשומה עומדת בתנאי הקידום, יש לבצע באותה הפעלה ככל האפשר: staging → witness check → normalization → dedup → canonical promotion.
- אין להשאיר promotion-ready ללא סיבה מתועדת.
- חסם בפריט אחד אינו עוצר batch שלם; החסום מתועד והעבודה ממשיכה בפריטים הנגישים.
- Verified אינו מואץ באמצעות הורדת הרף: הוא עדיין מחייב בדיקת witness ישיר/מוסמך ברמת הפריט.
- מדדי האתר נגזרים מ־data/public-metrics.json, שנבנה אוטומטית מספירה פיזית של המאגר.
